import { Provider as pProvider, useCreateStore as pUseCreateStore, useValue as pUseValue } from "tinybase/ui-react";
...
export const Provider = pProvider as UiReactWithSchemas["Provider"];
...
export const useCreateStore = pUseCreateStore as unknown as UiReactWithSchemas["useCreateStore"];
...
export const useValue = pUseValue as UiReactWithSchemas["useValue"];
